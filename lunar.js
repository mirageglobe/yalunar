;(function() {
  ...
  var zodiac=new Array("鼠","牛","虎","兔","龙","蛇","马","羊","猴","鸡","狗","猪");
  ...
  */
   ...
   */
  var cc = new CalendarConverter;
  var calDate = cc.solar2lunar(new Date(2011, 0, 3));

  cc.lunar2solar(new Date(2011, 0, 3));
  cc.solar2lunar(new Date(2010, 10, 29));

  console.log('lunar : ' + calDate.cDay)
})()
