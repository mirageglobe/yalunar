;(function () {
  ...
  */
  ...
  const solarTermBase = new Array(4, 19, 3, 18, 4, 19, 4, 19, 4, 20, 4, 20, 6, 22, 6, 22, 6, 22, 7, 22, 6, 21, 6, 21)
  ...
  */
  ...
  lalune.lunar2solar(new Date(2011, 0, 3))
  lalune.solar2lunar(new Date(2010, 10, 29))

  console.log('calDate : ' + calDate.lunarDay)
  console.log('lalune : ' + lalune.cMonth)
})()
